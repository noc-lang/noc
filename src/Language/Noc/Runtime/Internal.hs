...
data EvalError = ZeroDivisionError String | EmptyStackError String | TypeError String | NameError String | ValueError String | FileNotFoundError String deriving (Show, Eq)
